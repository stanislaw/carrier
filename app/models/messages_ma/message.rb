...
class Message < ActiveRecord::Base
  ...
  # Russian maps
  RUSSIAN_ATTRIBUTES = { :name => 'Название курса',
                         :content => 'Текст сообщения',
                         :reported_at => 'Дата, за которую производится отчёт:',
                         :"cmodules.name" => "Тема модуля",
                         :"cmodules.techniques.Название техники" => "Название техники" 
  }
